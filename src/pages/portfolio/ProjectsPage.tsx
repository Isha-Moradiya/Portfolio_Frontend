            ...
            {projects.map((project, idx) => (
              ...
              >
                <Card variant="light" hoverable className="flex flex-col h-full overflow-hidden">
                  <div className="relative h-56 bg-linear-to-br from-purple-100 to-purple-200 overflow-hidden">
                    {project.thumbnail && (
                      <img
                    ...
                    <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/0 to-black/0 opacity-0 group-hover:opacity-100 transition flex items-end p-6">
